...
"""
Django settings for lxdzx project.
...
SECRET_KEY = '+(_c!whs#rp45x56tg!-=xmk!ktq20*jfpr96(all*thh$-cum'
...
WSGI_APPLICATION = 'lxdzx.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'request_handler': {
            'level': 'DEBUG',
            'class': 'logging.handlers.RotatingFileHandler',
            'filename': tconf.BASE_DIR + '/log/script.log',
            'maxBytes': 1024 * 1024 * 5,
            'backupCount': 5,
            'formatter': 'standard',
        },
